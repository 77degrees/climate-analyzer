...
from routers import sensors, readings, weather, metrics, settings as settings_router, zones, dashboard, annotations, solar
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://localhost:5174", "http://localhost:3005", "http://127.0.0.1:5173", "http://127.0.0.1:3005"],
